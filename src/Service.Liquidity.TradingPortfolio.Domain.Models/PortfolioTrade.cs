...
namespace Service.Liquidity.TradingPortfolio.Domain.Models
{
    ...
    public class PortfolioTrade
    {
        ...
        [DataMember(Order = 2)] public string TradeId { get; set; }  // TradeMessage.Id & SwapMessage.Id
        [DataMember(Order = 3)] public string AssociateBrokerId { get; set; }  // TradeMessage.Id & SwapMessage.BrokerId
        [DataMember(Order = 4)] public string WalletName { get; set; }  // PortfolioWalletId
        [DataMember(Order = 5)] public string AssociateSymbol { get; set; }  //TradeMessage.AssociateSymbol   SwapMessage.AssetId1|AssetId2
        ...
        [DataMember(Order = 9)] public decimal Price { get; set; }  //TradeMessage.BaseAsset   SwapMessage.Buy проверить сторону 
        ...
        [DataMember(Order = 18)] public string Source { get; set; } //TradeMessage.Source   SwapMessage."Converter"
        [DataMember(Order = 19)] public string Comment { get; set; }//TradeMessage.Comment   SwapMessage."Swap with client"
        [DataMember(Order = 20)] public string User { get; set; } // User   SwapMessage."Converter"
        [DataMember(Order = 22)] public string FeeAsset { get; set; }  //TradeMessage.FeeAsset    SwapMessage.AssetId2
        [DataMember(Order = 23)] public decimal FeeVolume { get; set; }//TradeMessage.FeeVolume    SwapMessage.0
